...
# Create new cassandra container and test it
docker run -d \
...
This file provides focused examples — run the commands interactively to observe behavior and experiment with mount options and permissions.
```
